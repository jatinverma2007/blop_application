...
const CreateBlog = () => {
    ...
    const createBlogHandler = async () => {
        ...
        try {
            setLoading(true)
            const res = await axios.post(`${import.meta.env.VITE_API_URL}/api/v1/blog/`, { title, category }, {
                headers: {
    ...
    return (
        <div className='p-4 md:pr-20 h-screen md:ml-[320px] pt-20'>
            ...
            <p>Add a title and select a category to get started with your new blog post.</p>
            <div className='mt-10 '>
                <div>
                    <Label>Title</Label>
